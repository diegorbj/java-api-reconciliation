...
class ConfirmOperationServiceTest {
    ...
    private ConfirmOperationDTO testObject;

    private ConfirmInstallmentDTO testChildObject;

    @Test
    @Order(1)
    public void shouldReturnNotNullConfirmingOperationService() {
    ...
    @Test
    @Order(3)
    public void shouldReturnConfirmingOperationCreatedWithSuccess() throws JSONException {
        JSONObject jsonObject = setObjectToCreate();

        testObject = _service.insert(ConfirmOperationDTO.fromJSON(jsonObject));
    ...
    @Test
    @Order(4)
    public void shouldReturnConfirmingOperationUpdatedWithSuccess() throws JSONException {
        JSONObject jsonObject = setObjectToUpdate();
        ConfirmOperationDTO updatedObject = ConfirmOperationDTO.fromJSON(jsonObject);
    ...
    @Test
    @Order(5)
    public void shouldReturnNotNullConfirmingOperationFindAll() {
        assertNotNull(_service.findAll());
    }

    @Test
    @Order(6)
    public void shouldReturnNotNullConfirmingOperationFindById() {
    ...
    public void shouldReturnInstallmentCreatedWithSuccess() throws JSONException, JsonProcessingException {
        ...
        testChildObject = _childService.save(ConfirmInstallmentDTO.fromJSON(jsonObject));
        ...
        assertEquals(testChildObject.getOperation(), ConfirmOperationDTO.fromJSON(jsonObject.get("operation").toString()));
    }
    ...
    public void shouldReturnInstallmentUpdatedWithSuccess() throws JSONException, JsonProcessingException {
        ...
        ConfirmInstallmentDTO updatedObject = ConfirmInstallmentDTO.fromJSON(jsonObject);
        ...
        assertEquals(updatedObject.getOperation().getId(), ConfirmOperationDTO.fromJSON(jsonObject.get("operation").toString()).getId());
    ...
    @Test
    @Order(12)
    public void shouldReturnConfirmingOperationDeletedWithSuccess() {
