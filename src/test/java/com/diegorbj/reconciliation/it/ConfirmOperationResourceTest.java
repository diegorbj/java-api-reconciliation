...
class ConfirmOperationResourceTest {
    ...
    public void shouldReturnInsertSourceTransactions() throws Exception {
        ...
        this.mockMvc.perform(put("/reconciliation/v1/operations/confirms").contentType(MediaType.APPLICATION_JSON)
    ...
    public void shouldReturnUpdateSourceTransactions() throws Exception {
        ...
        this.mockMvc.perform(put("/reconciliation/v1/operations/confirms/4").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void shouldReturnFindByIdSourceTransactions() throws Exception {
        this.mockMvc.perform(get("/reconciliation/v1/operations/confirms/4")).andExpect(status().isOk());
    }

    @Test
    @Order(5)
    public void shouldReturnFindAllSourceTransactions() throws Exception {
        this.mockMvc.perform(get("/reconciliation/v1/operations/confirms")).andExpect(status().isOk());
    }
    ...
    public void shouldReturnInsertInstallments() throws Exception {
        ...
        this.mockMvc.perform(put("/reconciliation/v1/operations/confirms/4/installments").contentType(MediaType.APPLICATION_JSON)
                .content(mapToCreate.toString())).andExpect(status().isCreated());
    }
    ...
    public void shouldReturnUpdateinstallments() throws Exception {
        ...
        this.mockMvc.perform(put("/reconciliation/v1/operations/confirms/4/installments/1").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(mapToUpdate.toString())).andExpect(status().isOk());
    }
    ...
    public void shouldReturnFindByQuotaInstallments() throws Exception {
        this.mockMvc.perform(get("/reconciliation/v1/operations/confirms/4/installments/1")).andExpect(status().isOk());
    }

    @Test
    @Order(8)
    public void shouldReturnFindAllInstallments() throws Exception {
        this.mockMvc.perform(get("/reconciliation/v1/operations/confirms/4/installments")).andExpect(status().isOk());
    }

    @Test
    @Order(10)
    public void shouldReturnRemoveByQuotaInstallments() throws Exception {
        this.mockMvc.perform(delete("/reconciliation/v1/operations/confirms/4/installments/1")).andExpect(status().isNoContent());
    }

    @Test
    @Order(11)
    public void shouldReturnRemoveByIdSourceTransactions() throws Exception {
        this.mockMvc.perform(delete("/reconciliation/v1/operations/confirms/4")).andExpect(status().isNoContent());
    }
