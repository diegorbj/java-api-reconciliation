...
public class InitialLoadDev implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        AuditOperationDTO ao1 = new AuditOperationDTO(null, Instant.parse("2021-04-04T00:00:00.00Z"), 123456L,null, "", "987D54", TransactionStatus.APPROVED, 1, 130.00, "123456******3456", "1234-ABC-56789", m2, fi1, fs2, sl2, ct2, mod2);
        ao1 = _auditOperationService.save(ao1);
        _auditInstallmentService.save(new AuditInstallmentDTO(null, 1, 130.00, ao1));

        AuditOperationDTO ao2 = new AuditOperationDTO(null, Instant.parse("2021-04-05T00:00:00.00Z"),null, 789456L, "", "4687F3", TransactionStatus.CANCELED, 2, 150.00, "123456******3457", "1234-ABC-56789", m1, fi2, fs1, sl1, ct1, mod3);
        ...
        AuditOperationDTO ao3 = new AuditOperationDTO(null, Instant.parse("2021-04-06T00:00:00.00Z"), null,456132L, "", "852465", TransactionStatus.APPROVED, 3, 100.00, "123456******3458", "1234-ABC-56789", m3, fi2, fs1, sl1, ct3, mod3);
