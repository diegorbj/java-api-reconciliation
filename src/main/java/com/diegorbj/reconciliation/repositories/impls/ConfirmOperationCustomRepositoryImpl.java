...
import com.diegorbj.reconciliation.repositories.ConfirmOperationCustomRepository;
...
@Repository
public class ConfirmOperationCustomRepositoryImpl implements ConfirmOperationCustomRepository {

    @PersistenceContext//(unitName="reconciliation")
    private EntityManager _entityManager;

    @Override
    public List<ConfirmOperation> getWithFilter(OperationFilterParam params) {
        CriteriaBuilder criteriaBuilder = _entityManager.getCriteriaBuilder();
        CriteriaQuery<ConfirmOperation> query = criteriaBuilder.createQuery(ConfirmOperation.class);
        Root<ConfirmOperation> sourceTransaction = query.from(ConfirmOperation.class);
        ...
        TypedQuery<ConfirmOperation> queryResult = this._entityManager.createQuery(query);
