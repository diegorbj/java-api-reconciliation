...
public class ModalitiesApiIntegrationTest {
    ...
    @Test
    @Order(2)
    public void shouldReturnCreateModality() throws Exception {
    ...
    @Test
    @Order(4)
    public void shouldReturnGetOneModality() throws Exception {
        this.mockMvc.perform(get("/reconciliation/v1/modalities/1")).andExpect(status().isOk());
    }

    @Test
    @Order(5)
    public void shouldReturnGetAllModalities() throws Exception {
        this.mockMvc.perform(get("/reconciliation/v1/modalities")).andExpect(status().isOk());
    }

    @Test
    @Order(6)
    public void shouldReturnRemoveAllModalities() throws Exception {
